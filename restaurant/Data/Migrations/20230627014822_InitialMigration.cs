    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_persona = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    nombre_persona = table.Column<string>(type: "text", nullable: false),
                    apellidoPaterno_persona = table.Column<string>(type: "text", nullable: false),
                    apellidoMaterno_persona = table.Column<string>(type: "text", nullable: false),
                    telefono_persona = table.Column<string>(type: "text", nullable: false),
                    sexo_persona = table.Column<char>(type: "character(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_usuario", x => x.id_categoria);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataRepartidor", x => x.id_categoria);
                    table.ForeignKey(
                        name: "FK_DataRepartidor_usuario_usuarioid_usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_categoria = table.Column<string>(type: "text", nullable: false),
                    categoria_tarjeta = table.Column<char>(type: "character(1)", nullable: false),
                    usuarioid_usuario = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tarjeta", x => x.id_categoria);
                    table.ForeignKey(
                        name: "FK_tarjeta_usuario_usuarioid_usuario",
                        column: x => x.usuarioid_usuario,
                        principalTable: "usuario",
                        principalColumn: "id_categoria",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataRepartidor_usuarioid_usuario",
                table: "DataRepartidor",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tarjeta_usuarioid_usuario",
                table: "tarjeta",
                column: "usuarioid_usuario");
